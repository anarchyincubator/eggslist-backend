...
urlpatterns = [
    ...
    path("profile-small", views.UserSmallProfileView.as_view(), name="current-small"),
    path("profile-full", views.UserProfileFullAPIView.as_view(), name="current-full"),
    ...
    path("connect-stripe", views.ConnectStripeCreateAPIView.as_view(), name="connect-stripe"),
]
# fmt: on
